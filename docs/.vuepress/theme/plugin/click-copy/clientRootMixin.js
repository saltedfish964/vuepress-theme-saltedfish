...
export default {
  ...
  methods: {
    ...
    generateCopyButton(parent) {
      if (parent.parentElement.classList.contains('codecopy-enabled')) return
      ...
      parent.parentElement.appendChild(copyElement)
      parent.parentElement.classList.add('codecopy-enabled')
    },
    copyToClipboard(str) {
